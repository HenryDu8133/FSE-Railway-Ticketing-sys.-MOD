...
public class ExpTicketItem extends Item {
	public ExpTicketItem(){super(new Item.Properties().stacksTo(64).fireResistant().component(DataComponents.CUSTOM_DATA,def()));}
	private static CustomData def(){CompoundTag t=new CompoundTag();t.putString("start_name_en","");t.putString("terminal_name_en","");t.putString("start_station","");t.putString("terminal_station","");t.putString("fromNameCnU","");t.putString("toNameCnU","");t.putString("type","limited_express");t.putInt("rides",1);t.putBoolean("entered",false);t.putBoolean("exited",false);t.putString("ticketId","");t.putLong("timestamp",0);t.putDouble("cost",0);t.putString("order_datetime","");return CustomData.of(t);}
