...
public class LocalTicketGUIScreen extends AbstractContainerScreen<LocalTicketGUIMenu>
...
@Override protected void renderLabels(GuiGraphics g, int mx, int my) {
		LocalTicketGUIMenu m = (LocalTicketGUIMenu) menu;
		...
		g.drawString(font, TJF("gui.fseticket.local_ticket_gui.label_a_fare_ticket"), -49, -59, -16777216, false);
		g.drawString(font, TJF("gui.fseticket.local_ticket_gui.label_empty"), -12, -46, -16777216, false);
		g.drawString(font, LJF(from), -108, -32, -16777216, false);
		g.drawString(font, LJF(to), 21, -31, -16777216, false);
		g.drawString(font, LJF(rides), -76, -4, -16777216, false);
		g.drawString(font, LJF(tid), 47, 75, -16777216, false);
		g.drawString(font, TJF("gui.fseticket.local_ticket_gui.label_ben_piao_ke_gong_ci_cheng_che"), -115, -4, -16777216, false);
		g.drawString(font, TJF("gui.fseticket.local_ticket_gui.label_trips"), -59, -4, -12829636, false);
		g.drawString(font, TJF("gui.fseticket.local_ticket_gui.label_empty1"), -115, 9, -12829636, false);
		g.drawString(font, TJF("gui.fseticket.local_ticket_gui.label_qing_ping_ci_piao_zai_zhi_ding_che_zhan_jin_zhan_cheng_che"), -117, 54, -12829636, false);
		g.drawString(font, TJF("gui.fseticket.local_ticket_gui.label_tuo_shan_bao_guan_yi_shi_bu_bu"), -117, 67, -12829636, false);
		...
		g.drawString(font, TJF("gui.fseticket.local_ticket_gui.label_cheng_che_quan"), -14, -70, -12829636, false);
		g.drawString(font, LCF(fcnu), -108, -46, -12829636, false);
		g.drawString(font, LCF(tcnu), 20, -46, -12829636, false);
	}
	@Override public void init() {
		super.init();
		String tid = nv(((LocalTicketGUIMenu)menu).ticketId);
