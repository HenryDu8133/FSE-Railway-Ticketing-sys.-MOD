...
@Override protected void renderLabels(GuiGraphics g, int mx, int my) {
		...
		g.drawString(font, TJF("gui.fseticket.local_ticket_gui.label_type"), -49, -59, -16777216, false);
		g.drawString(font, TJF("gui.fseticket.local_ticket_gui.label_arrow"), -12, -46, -16777216, false);
		...
		g.drawString(font, TJF("gui.fseticket.local_ticket_gui.label_validtrip1"), -115, -4, -16777216, false);
		g.drawString(font, TJF("gui.fseticket.local_ticket_gui.label_validtrip2"), -59, -4, -12829636, false);
		g.drawString(font, TJF("gui.fseticket.local_ticket_gui.label_tip1"), -117, 54, -12829636, false);
		g.drawString(font, TJF("gui.fseticket.local_ticket_gui.label_tip2"), -117, 67, -12829636, false);
		...
		g.drawString(font, TJF("gui.fseticket.local_ticket_gui.label_title"), -14, -70, -12829636, false);
