...
import java.util.*;
public class LocalTicketGUIMenu extends AbstractContainerMenu implements FseticketModMenus.MenuAccessor {
	...
	public LocalTicketGUIMenu(int id,Inventory inv,FriendlyByteBuf buf){
		super(FseticketModMenus.LOCAL_TICKET_GUI.get(),id);
