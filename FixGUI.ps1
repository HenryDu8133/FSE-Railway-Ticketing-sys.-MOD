# FixGUI.ps1
$jsonFile = "D:\TaoYuan2023_HSTG\HSTG\MODCreate\fseticket\elements\LocalTicketGUI.mod.json"
$outFile = "D:\TaoYuan2023_HSTG\HSTG\MODCreate\fseticket\src\main\java\net\fsefmgftc\fseticket\client\gui\LocalTicketGUIScreen.java"
...
foreach ($l in $labels) {
    ...
    if ($v) {
        ...
        [void]$sb.AppendLine("`t`tg.drawString(font, T$fnt(`"gui.fseticket.local_ticket_gui.$($l.name)`"), $($l.x), $($l.y), $($l.color), $($l.shadow));")
    }
}
